 ...
 * @date 2024-04-09 22:59
 * @since 0.0.1-SNAPSHOT
 */
//@Component
public class AuthorityBeforeSaveConvert implements BeforeConvertCallback<Authority> {

    @Resource
    private SnowFlake idGenerator;
    @Override
    public Publisher<Authority> onBeforeConvert(Authority entity, SqlIdentifier table) {
        if (entity == null) {
