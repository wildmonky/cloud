 ...
 * @date 2024-04-09 23:02
 * @since 0.0.1-SNAPSHOT
 */
//@Component
public class RoleBeforeSaveConvert implements BeforeConvertCallback<Role> {

    @Resource
    private SnowFlake idGenerator;
    @Override
    public Publisher<Role> onBeforeConvert(Role entity, SqlIdentifier table) {
        if (entity == null) {
